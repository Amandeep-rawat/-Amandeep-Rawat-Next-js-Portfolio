// components/Hero.tsx (Client-side logic wrapped in ThemeLayout)
      ...
      <div className='pb-20 pt-36 '>
        ...
        <div className="flex justify-center relative my-20 z-10">
          ...
          <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col max-sm:gap-3 items-center justify-center'>
            ...
            <TextGenerateEffect className='text-center text-[30px] md:text-5xl lg:text-[6xl]' words='Crafting seamless solutions with a blend of creativity and code'/>
            <p className='text-center md:tracking-wider text-sm md:text-lg lg:text-2xl mb-4'> Hi , I&apos;m
               {/* <Cover className=''> */}
                 Amandeep Rawat🚀 
                 {/* </Cover> */}
